...
export default function AdminApp() {
  ...
  async function cargarTodo() {
    ...
    const [{ data: efs }, { data: disp }, { data: turns }] = await Promise.all([
      ...
      // Solo turnos de sectores de este lugar
  ...
  async function generarTurnos() {
    ...
    // Solo borrar turnos de sectores de este lugar
  ...
  useEffect(() => {
    if (planillaEf) {
      // Solo turnos de este lugar (SECTORES_APP)
      ...
      const asistMap = {}
      // FIX: solo asistencias que corresponden a turnos de este lugar
